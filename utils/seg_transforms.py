...
class RotatePair(object):
    def __init__(self, p=0.5, angle=(-45, 45)):
        self.p = p
        self.angle = angle
...
class ImgTransform:
    ...
    def __init__(self):
        self.aug = iaa.Sequential([
            iaa.Sometimes(0.35, iaa.GammaContrast((0.75, 1.25))),
            iaa.Sometimes(0.35, iaa.AddToHueAndSaturation(value=(-20, 20), per_channel=True)),
        ])
